...
{
    [Title("Procedural", "Noise", "Simplex Noise 3D")]
    public class SimplexNoise3DNode : CodeFunctionNode
    {
        ...
        {
            return GetType().GetMethod("ShaderGraphExtensions_SimplexNoise3D", BindingFlags.Static | BindingFlags.NonPublic);
        }
        static string ShaderGraphExtensions_SimplexNoise3D(
            [Slot(0, Binding.None)] Vector3 Position,
            [Slot(1, Binding.None, 2, 2, 2, 2)] Vector1 Scale,
            [Slot(2, Binding.None)] out Vector1 Out)
        {
            return "{ Out = sge_simplexNoise3D(Position * Scale) + 0.5; }";
        }
